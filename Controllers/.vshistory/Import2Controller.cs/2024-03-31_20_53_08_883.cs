...
namespace ImportExcelSql.Controllers
{
    public class Import2Controller : Controller
    {
        ...
        public ActionResult File()
        {
            ...
            model.EmployeeListViewModel = new List<CarViewModel>();
            return View(model);
        }
        [HttpPost]
        public ActionResult File(FileUploadViewModel model)
        {
            ...
            using (ExcelPackage package = new ExcelPackage(file))
            {
                ...
                else
                {
                    ...
                    {
                        model.EmployeeListViewModel.Add(new CarViewModel
                        {
                            ...
                            engineLocation = (worksheet.Cells[row, 3].Value ?? string.Empty).ToString().Trim(),
                            numberOfCylinders = (worksheet.Cells[row, 3].Value ?? string.Empty).ToString().Trim(),
                        });
                    }
                }
            }
        ...
        //public ActionResult ImportOnly(FormCollection form)
        {
            ...
            var totalStudentsSql = new List<Car>();
